...
1. Плейлист на странице записи.
2. Информация о видео на странице архива/метки/рубрики (Включена опция "Видео только на страницах записей").
3. Экран настроек плагина.
